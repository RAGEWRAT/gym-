  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 pt-24 pb-20 text-center bg-navy text-offwhite">
      ...
      <p className="text-gray-400 max-w-md mb-10">
        Our team will confirm your slot shortly. Prefer WhatsApp? Tap below and we&apos;ll pick up the thread there.
      </p>
      <div className="flex flex-col sm:flex-row gap-4">
        <a
          href={whatsappHref("Hi IronForge! I just submitted a booking on the website.")}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center gap-2 rounded-md bg-[#25D366] px-6 py-3 font-bold text-white hover:opacity-90"
        >
